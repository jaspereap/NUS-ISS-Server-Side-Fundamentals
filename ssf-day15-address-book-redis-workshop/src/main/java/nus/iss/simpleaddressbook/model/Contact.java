...
public class Contact {
    ...
    public Contact(String name, String email, String phone, LocalDate dob, String userId) {
        this.name = name;
        this.email = email;
        this.dob = dob;
        this.phone = phone;
        this.hexString = userId;
    }
    ...
    public String toString() {
        return "Contact [name=" + name + ", email=" + email + ", phone=" + phone + ", dob=" + dob + ", hexString="
                + hexString + "]";
    }
