package nus.iss.day15.redis.cart.configuration;
...
public class AppConfig {
   ...
   public RedisTemplate<String, String> createRedisConnection() {
      ...
      logger.info("Testing");
      logger.info("Using Redis database number: " + redisPort);
      logger.info("Using properties password: " + (redisPassword != "NOT_SET"));
